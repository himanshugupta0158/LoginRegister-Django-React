...
const Signup = ({ signup, isAuthenticated }) => {
    ...
    const onSubmit = e => {
        ...
        if (password === re_password) {
            ...
            document.getElementById('register_message').innerText = 'Password and Confirm Password do not match';
            document.getElementById('register_message').className = 'alert alert-danger';
